...
const sampleTasks: Task[] = [
  {
    ...
    description:
      'Complete initial review of all medical records received from City General Hospital.',
    category: 'medical',
    priority: 'high',
    status: 'in_progress',
            ...
            <Dialog open={newTaskDialogOpen} onOpenChange={setNewTaskDialogOpen}>
              ...
              <DialogContent className="sm:max-w-[600px]">
                ...
                <div className="grid gap-6 py-4">
                  ...
                  <div className="grid gap-2">
                    <Textarea placeholder="Task description" className="min-h-[100px]" />
                  </div>
            ...
            <TableBody>
              {filteredTasks.map((task) => (
                <TableRow key={task.id}>
                  ...
                  <TableCell>
                    <div
                      className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${statusConfig[task.status].color}`}
                    >
