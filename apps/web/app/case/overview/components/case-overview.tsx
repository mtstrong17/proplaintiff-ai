...
import { AlertCircle, Calendar, Clock, DollarSign, FileText, Users } from 'lucide-react';
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Since case opened</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Involved in the case</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Current stage and completion status</CardDescription>
        </CardHeader>
        <CardContent>
...
function PriorityIcon({ priority }: { priority: string }) {
  ...
  return <AlertCircle className={`h-4 w-4 ${colors[priority as keyof typeof colors]}`} />;
}
