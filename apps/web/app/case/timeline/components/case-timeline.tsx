...
type TimelineEvent = {
  id: string
  date: Date
  type: "document" | "communication" | "milestone" | "deadline" | "note" | "status" | "medical" | "incident"
  title: string
  description: string
                  ...
                  <div className="p-4">
                    <div className="flex items-start justify-between">
                      <div className="flex items-start gap-3">
                        <div className={`rounded-full p-2 ${categoryColors[event.category]} shrink-0`}>
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            {event.priority && (
                              <div className={`h-2 w-2 rounded-full ${priorityColors[event.priority]}`} />
                            )}
                          </div>
